...
repository to be uploaded in place, as rsync is particularly efficient in this
fashion.  If that is the case we'll need to use a fixed transport-location, rather
than a new directory per-execution.
